This project is to give programmers a platform to help us use programming/Machine Learning to fight with 2019–20
coronavirus pandemic. Calling all programmers to use engineering and help medical science to fight with this.

Two goals:
    1. Predict accurately present state, & study about spread pattern.
    2. Learn about SARS-CoV-2, COVID 19.
    3. Keep all resources at one place including COVID-19 Open Research Dataset (CORD-19)
